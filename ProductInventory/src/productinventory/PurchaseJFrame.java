...
public class PurchaseJFrame extends javax.swing.JFrame {
    ...
    public void Vendor() {
        try {
            preparedStatement = connection.prepareStatement("SELECT DISTINCT vendor_name from vendor_tbl");
            resultSet = preparedStatement.executeQuery();
            
            vendorJComboBox.removeAllItems();
            
            while(resultSet.next()) {
                vendorJComboBox.addItem(resultSet.getString("vendor_name"));
            }
    ...
    public void ProductID(){
        try {
            ...
            if(resultSet.next() == false) {
                ...
                String price = resultSet.getString("product_cost_price");
    ...
    public void Purchase() {
        ...
        defaultTable = (DefaultTableModel)purchaseJTable.getModel();
        ...
        for (int i = 0; i < purchaseJTable.getRowCount(); i++) {
            sum += Integer.parseInt(purchaseJTable.getValueAt(i, 4).toString());
        }
    ...
    public void Add() {
        try {
            ...
            String vendor_name = vendorJComboBox.getSelectedItem().toString();
            ...
            String query1 = "INSERT INTO purchase_tbl (date,vendor_name,subtotal,payment,balance) VALUES (?,?,?,?,?)";
            ...
            String query2 = "INSERT INTO purchase_item_tbl(purchase_id,product_id,product_cost_price,quantity,total) VALUES (?,?,?,?,?)";
            ...
            for (int i = 0; i < purchaseJTable.getRowCount(); i++) {
                productid = (String)purchaseJTable.getValueAt(i, 0);
                price = (String)purchaseJTable.getValueAt(i, 2);
                quantity = (String)purchaseJTable.getValueAt(i, 3);
                total = (int)purchaseJTable.getValueAt(i, 4);
    ...
    private void initComponents() {
        ...
        purchaseJLabel = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        vendorJComboBox = new javax.swing.JComboBox<>();
        ...
        purchaseJLabel.setFont(new java.awt.Font("Cooper Black", 0, 18)); // NOI18N
        purchaseJLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        purchaseJLabel.setText("PURCHASE");
        ...
        viewSalesReportJButton.setText("View Purchase Report");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(purchaseJLabel)
                        .addGap(18, 18, 18)
                        .addComponent(viewSalesReportJButton)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jLabel1)
                        .addGap(18, 18, 18)
                        .addComponent(vendorJComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(30, 30, 30))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(purchaseJLabel)
                    .addComponent(jLabel1)
                    .addComponent(vendorJComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(viewSalesReportJButton))
                .addGap(18, 18, 18)
    ...
    private javax.swing.JLabel purchaseJLabel;
    ...
    private javax.swing.JComboBox<String> vendorJComboBox;
